namespace NovelCsam.Helpers.Interfaces
{
	public interface IVideoHelper
	{
		...
		public Task<string> UploadFrameResultsDurableFunctionAsync(string containerName, string containerFolderPath, string containerFolderPathResults, bool withBase64ofImage = false, bool getSummaryB = true, bool getChildYesNoB = true);
