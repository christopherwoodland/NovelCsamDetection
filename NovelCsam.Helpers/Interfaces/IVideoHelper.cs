namespace NovelCsamDetection.Helpers.Interfaces
{
	public interface IVideoHelper
	{
		...
		//public Task UploadFrameResultsToBlobAsync(string containerName, string containerFolderPath, string containerFolderPathResults, bool withBase64ofImage = false);
		public Task UploadFrameResultsToBlobAsync(string containerName, string containerFolderPath, string containerFolderPathResults, bool withBase64ofImage = false);
