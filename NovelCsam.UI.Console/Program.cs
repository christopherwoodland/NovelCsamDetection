internal class Program
{
	...
	public static void SelectAndUploadImages(IVideoHelper app, string CNVIDEOS, string CNINPUT)
	{
						...
						case "5":
							...
							if (dirList?.Result.Count > 0)
							{
								...
								if (!string.IsNullOrEmpty(chosenDirValue))
								{
									...
									app.UploadFrameResultsToBlobAsync(CNVIDEOS, chosenDirValue, CNRESULTS, true);
								}
