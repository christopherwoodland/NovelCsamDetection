...
{
    public class ExtractFramesHelper : IExtractFramesHelper
	{
        ...
        private readonly IKeyVaultHelper _kvh;
        private readonly IStorageHelper _sh;

		public ExtractFramesHelper(ILogHelper logHelper, IKeyVaultHelper kvh, IStorageHelper _sh)
        {
            _logHelper = logHelper;
            _kvh = kvh;
			//_sh = sh;
		}
        //public async Task<bool> StartExtractFramesAsync(string fileFolderNameParam, string keyVaultParam, string sourceContainerNameParam, string sourceDirPathParam, string destDirPathExtParam, string storageAccountNameParam, string storage)
        //{
